...
export class LearningMaterialsComponent {
 learningMaterials: LearningMaterial[] = [
    {
      id: '1',
      title: '.NET Core Microservices Architecture',
      description: 'Complete guide to building scalable microservices using .NET Core, Docker, and Azure Service Bus. Learn how to implement distributed systems patterns.',
      category: '.NET Core',
      difficulty: 'Advanced',
      duration: '2.5 hours',
      tags: ['.NET Core', 'Microservices', 'Docker', 'Azure', 'API Gateway'],
      type: 'course',
      link: '#',
